...
function promptcmd(){
    PREVRET=$?
    PS1="\n"
    PS1="${PS1}\[\033[1;34m\]\u\[\033[0;32m\]@\h on ${_ip_add}:\[\033[0;36m\]\w\[\033[0;32m\]"
    PS1="${PS1}\[\033[0m\033[1;33m\]$(__git_status)"

    if [  $PREVRET -eq 0  ]; then
        PS1="${PS1}\n\[\033[0;32m\]└─[\D{%T}]"
    else
        PS1="${PS1}\n\[\033[0;32m\]└─[\[\033[0;31m\]:(\033[0;32m\]]"
    fi
...
alias run="$LLVM_HOME/build/bin/clang-hw2 examples/gcd.c --"
